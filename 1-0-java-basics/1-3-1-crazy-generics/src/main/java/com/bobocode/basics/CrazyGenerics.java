...
public class CrazyGenerics {
    ...
    public static class Limited<T extends Number> {
        ...
        private final T actual = null;
        private final T min = null;
        private final T max = null;
    }
...
return  entities.stream()
        ...
        /**
         * Util method that checks if a provided collection of entities is valid.
         * An entity is any subclass of
