...
public class HeterogeneousMaxHolder {
    private Map<Class<?>, Object> maxValues = new HashMap<>();
    ...
    /**
     * An overloaded method put implements the same logic using a custom comparator.
     * A given comparator is wrapped with
