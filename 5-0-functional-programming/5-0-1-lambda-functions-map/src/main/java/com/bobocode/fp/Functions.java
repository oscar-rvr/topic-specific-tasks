...
public class Functions {
    ...
    public static FunctionMap<Integer, Integer> intFunctionMap() {
        ...
        // Agregar las funciones usando lambdas
        intFunctionMap.put("abs", x -> Math.abs(x));
        intFunctionMap.put("sgn", x -> Integer.signum(x));
        intFunctionMap.put("increment", x -> x + 1);
        intFunctionMap.put("decrement", x -> x - 1);
        intFunctionMap.put("square", x -> x * x);
